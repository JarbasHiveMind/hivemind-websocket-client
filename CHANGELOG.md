...
- fix: a wire payload must be a JSON object, and nothing repairs it [\#290](https://github.com/JarbasHiveMind/hivemind-websocket-client/pull/290) ([openvoiceos-bot](https://github.com/openvoiceos-bot))
...
- fix: a named application reads the shared identity until it has its own [\#284](https://github.com/JarbasHiveMind/hivemind-websocket-client/pull/284) ([openvoiceos-bot](https://github.com/openvoiceos-bot))
...
- fix: refuse a HANDSHAKE request once the session key is set [\#273](https://github.com/JarbasHiveMind/hivemind-websocket-client/pull/273) ([openvoiceos-bot](https://github.com/openvoiceos-bot))
...
- fix: stop the worker on close\(\) and retry a hub that sends nothing [\#271](https://github.com/JarbasHiveMind/hivemind-websocket-client/pull/271) ([openvoiceos-bot](https://github.com/openvoiceos-bot))
...
- fix\(identity\): keep key paths usable when the identity file moves [\#233](https://github.com/JarbasHiveMind/hivemind-websocket-client/pull/233) ([goldyfruit](https://github.com/goldyfruit))
- fix\(http\): advertise protocol v3 so HiveMindHTTPClient does not decline the Noise handshake [\#220](https://github.com/JarbasHiveMind/hivemind-websocket-client/pull/220) ([goldyfruit](https://github.com/goldyfruit))
