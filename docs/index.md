...
- [Client API Guide](client_api.md) - Using `HiveMessageBusClient` and `HiveMindHTTPClient`.
- [Message Structure](message_types.md) - `HiveMessage` types and routing modes.
- [Handling Binary Data](binary_handlers.md) - Subclassing `BinaryDataCallbacks` for audio and files.
- [CLI Reference](cli_guide.md) - Using the `hivemind-client` command-line tool.
