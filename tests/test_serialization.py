...
class TestDecodeBitstring(unittest.TestCase):
    ...
    def test_escalate_roundtrip(self):
        ...
        # this library read §4 as refusing an empty payload for the envelope-
        # carrying types: the subject here is that the codec preserves the
        # msg_type, and the payload was incidental filler that the decoder
        # now refuses at the door.
